...
public:
	...
	// Our shader program
	std::shared_ptr<Program> prog, heightshader, psky;
...
#define MESHSIZE 100
	...
	void initGeom()
	{
		...
		//texture 1
		string str = resourceDirectory + "/grand.jpeg";
...
//        P = glm::perspective(radians<float>(3.14159 / 4.), (float)((float)width / (float)height), 0.1f, 1.0f);
        float sangle = 3.14159 / 2.;
